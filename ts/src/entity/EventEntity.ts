...
class EventEntity extends GcalEntityBase<Event> {
  ...
  async update(this: any, reqdata?: EventUpdateData, ctrl?: Control): Promise<EventEntity> {
  ...
  async remove(
    this: any, reqmatch?: EventRemoveMatch, ctrl?: Control,
  ): Promise<EventEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<EventEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
