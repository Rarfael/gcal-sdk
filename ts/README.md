...
The TypeScript SDK for the Gcal API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Event()` — each with a small set of operations (`list`, `load`, `create`, `update`, `remove`)
...
```ts
import { GcalSDK } from '@voxgig-sdk/gcal'
