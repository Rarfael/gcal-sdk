...
func NewEventEntity(client *core.GcalSDK, entopts map[string]any) *EventEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EventEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// EventUpdateData and returns an Event. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *EventEntity) UpdateTyped(reqdata EventUpdateData, ctrl map[string]any) (Event, error) {
...
func (e *EventEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// EventRemoveMatch and returns an Event. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *EventEntity) RemoveTyped(reqmatch EventRemoveMatch, ctrl map[string]any) (Event, error) {
