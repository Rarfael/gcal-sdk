...
// Gcal SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class GcalMakeRequest
{
    public static function call(GcalContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new GcalResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new GcalResponse($fetched);
        } else {
