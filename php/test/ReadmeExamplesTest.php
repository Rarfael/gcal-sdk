...
// Gcal SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (GcalSDK::test)
...
{
    private const SDK_CLASS = 'GcalSDK';
    ...
    private const SDK_BASE = 'gcal_sdk';
