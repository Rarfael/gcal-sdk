...
class EventEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set GCAL_TEST_EVENT_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $event_ref01_resdata_up0 = Helpers::to_map(is_object($event_ref01_resdata_up0_result) && method_exists($event_ref01_resdata_up0_result, 'data_get') ? $event_ref01_resdata_up0_result->data_get() : $event_ref01_resdata_up0_result);
...
function event_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("GCAL_TEST_EVENT_ENTID");
