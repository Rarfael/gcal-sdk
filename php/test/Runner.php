...
class GcalTestRunner
{
    ...
    {
        $live = self::getenv('GCAL_TEST_LIVE');
        $override = self::getenv('GCAL_TEST_OVERRIDE');
        ...
        $explain = self::getenv('GCAL_TEST_EXPLAIN');
...
class_alias('GcalTestRunner', 'Runner');
class_alias('GcalHelpers', 'Helpers');
