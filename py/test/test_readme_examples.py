# Gcal SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions GcalSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both GcalSDK(...) and GcalSDK.test(...) become
#      GcalSDK.test({"entity": {...}}) seeding one mock record (id "test01")
