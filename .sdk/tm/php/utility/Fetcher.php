...
class GcalFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; GcalSDK/1.0)';
    ...
    public static function call(GcalContext $ctx, string $fullurl, array $fetchdef): array
    {
