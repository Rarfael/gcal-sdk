...
// Gcal SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class GcalTestFeature extends GcalBaseFeature
{
    ...
    public function init(GcalContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (GcalContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (GcalContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(GcalContext $ctx, $op, $args): array
    {
