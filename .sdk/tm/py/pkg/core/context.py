...
from projectname_sdk.core.control import GcalControl
...
class GcalContext:
    ...
    def make_error(self, code, msg):
        return GcalError(code, msg, self)
