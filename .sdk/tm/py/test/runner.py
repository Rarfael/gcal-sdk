...
class GcalTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = GcalTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = GcalTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = GcalTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
