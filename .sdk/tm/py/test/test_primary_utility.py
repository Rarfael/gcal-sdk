...
from projectname_sdk import GcalSDK
from projectname_sdk.core.spec import GcalSpec
from projectname_sdk.core.result import GcalResult
from projectname_sdk.core.response import GcalResponse
from projectname_sdk.core.operation import GcalOperation
from projectname_sdk.core.error import GcalError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import GcalBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = GcalSDK.test(None, None)
        ...
        class TestInitFeature(GcalBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(GcalBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = GcalSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = GcalSDK.test(None, setup_opts)
