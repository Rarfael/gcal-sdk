...
GcalSDK._make_feature = _make_feature


function GcalSDK.new(options)
  local self = setmetatable({}, GcalSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function GcalSDK:get_utility()
  return Utility.copy(self._utility)
end


function GcalSDK:get_root_ctx()
  return self._rootctx
end


function GcalSDK:prepare(fetchargs)
...
function GcalSDK:direct(fetchargs)
...
-- by passing it.
function GcalSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function GcalSDK:graphql(query, variables, ctrl)
...
function GcalSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
